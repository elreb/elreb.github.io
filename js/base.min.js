if (!function(t, e) {
    ...
    function o(t, e, n) {
        ...
        }) : St.test(e) ? ht.filter(e, t, n) : (e = ht.filter(e, t),
    ...
    function p(t, e, n) {
        ...
        if (void 0 === n && 1 === t.nodeType)
            if (i = "data-" + e.replace(Pt, "-$&").toLowerCase(),
            n = t.getAttribute(i),
            "string" == typeof n) {
                try {
                    n = f(n)
    ...
    function h(t, e, n, i) {
        ...
        , l = a(), c = n && n[3] || (ht.cssNumber[e] ? "" : "px"), u = (ht.cssNumber[e] || "px" !== c && +l) && Wt.exec(ht.css(t, e));
        if (u && u[3] !== c) {
            c = c || u[3],
            n = n || [],
            u = +l || 1;
    ...
    function v(t, e) {
        ...
        void 0 === e || e && ht.nodeName(t, e) ? ht.merge([t], n) : n
    }
    function y(t, e) {
    ...
    function D(t, e, i, o) {
        ...
        if (g || f > 1 && "string" == typeof h && !ft.checkClone && ne.test(h))
            return t.each(function(n) {
                var r = t.eq(n);
                g && (e[0] = h.call(this, n, r.html())),
                D(r, e, i, o)
            });
        if (f && (r = b(e, t[0].ownerDocument, !1, t, o),
        s = r.firstChild,
        1 === r.childNodes.length && (r = s),
        s || o)) {
            for (a = ht.map(v(r, "script"), $),
            l = a.length; d < f; d++)
                c = r,
                d !== p && (c = ht.clone(c, !0, !0),
                l && ht.merge(a, v(c, "script"))),
                i.call(t[d], c, d);
            if (l)
                ...
                d = 0; d < l; d++)
                    c = a[d],
                    Qt.test(c.type || "") && !Lt.access(c, "globalEval") && ht.contains(u, c) && (c.src ? ht._evalUrl && ht._evalUrl(c.src) : n(c.textContent.replace(oe, ""), u))
        }
        return t
    }
    function A(t, e, n) {
        for (var i, o = e ? ht.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
            n || 1 !== i.nodeType || ht.cleanData(v(i)),
            i.parentNode && (n && ht.contains(i.ownerDocument, i) && y(v(i, "script")),
    ...
    function L(t, e, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
            "margin" === n && (s += ht.css(t, n + Mt[r], !0, o)),
            i ? ("content" === n && (s -= ht.css(t, "padding" + Mt[r], !0, o)),
            "margin" !== n && (s -= ht.css(t, "border" + Mt[r] + "Width", !0, o))) : (s += ht.css(t, "padding" + Mt[r], !0, o),
            "padding" !== n && (s += ht.css(t, "border" + Mt[r] + "Width", !0, o)));
        return s
    }
    function R(t, e, n) {
        ...
        i <= 0 || null == i) {
            ...
            se.test(i))
                return i;
            o = s && (ft.boxSizingReliable() || i === t.style[e]),
            i = parseFloat(i) || 0
        }
        return i + L(t, e, n || (s ? "border" : "content"), o, r) + "px"
    }
    function q(t, e, n, i, o) {
        return new q.prototype.init(t,e,n,i,o)
    }
    function P() {
        he && (t.requestAnimationFrame(P),
        ht.fx.tick())
    }
    function H() {
    ...
    function B(t, e, n) {
        var i, o, r, s, a, l, c, u, d = "width"in e || "height"in e, f = this, p = {}, h = t.style, g = t.nodeType && Bt(t), v = Lt.get(t, "fxshow");
        ...
        if (l = !ht.isEmptyObject(e),
        l || !ht.isEmptyObject(p)) {
    ...
    function _(t, e, n) {
        ...
        for (U(u, c.opts.specialEasing); r < s; r++)
            if (i = _.prefilters[r].call(c, t, u, c.opts))
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = s[e],
                    i = t[e],
                    s !== i && (c && i && (ht.isPlainObject(i) || (o = ht.isArray(i))) ? (o ? (o = !1,
                    r = n && ht.isArray(n) ? n : []) : r = n && ht.isPlainObject(n) ? n : {},
    ...
    ht.extend({
        ...
        isPlainObject: function(t) {
            var e, n;
            return !(!t || "[object Object]" !== lt.call(t) || (e = nt(t)) && (n = ct.call(e, "constructor") && e.constructor,
            "function" != typeof n || ut.call(n) !== dt))
        },
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (i(Object(t)) ? ht.merge(n, "string" == typeof t ? [t] : t) : rt.call(n, t)),
            n
        },
    ...
    "function" == typeof Symbol && (ht.fn[Symbol.iterator] = tt[Symbol.iterator]),
    ...
    var bt = function(t) {
        function e(t, e, n, i) {
            ...
            "string" != typeof t || !t || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!i && ((e ? e.ownerDocument || e : M) !== O && F(e),
            e = e || O,
            L)) {
                if (11 !== h && (l = vt.exec(t)))
                    if (o = l[1]) {
                        if (9 === h) {
                            ...
                            if (s.id === o)
                                return n.push(s),
                                n
                        } else if (f && (s = f.getElementById(o)) && H(e, s) && s.id === o)
                            return n.push(s),
                            n
                    } else {
                        if (l[2])
                            ...
                            n;
                        if ((o = l[3]) && T.getElementsByClassName && e.getElementsByClassName)
                ...
                if (T.qsa && !V[t + " "] && (!R || !R.test(t))) {
                    if (1 !== h)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(wt, Tt) : e.setAttribute("id", a = W),
                        c = E(t),
                        r = c.length; r--; )
                            c[r] = "#" + a + " " + p(c[r]);
                        u = c.join(","),
                        f = yt.test(t) && d(e.parentNode) || e
                    }
                    if (u)
                        try {
        ...
        function y(t, e, n, o, r, s) {
            ...
            r && !r[W] && (r = y(r, s)),
            i(function(i, s, a, l) {
                var c, u, d, f = [], p = [], h = s.length, g = i || m(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? g : v(g, f, t, a, l), b = n ? r || (i ? t : h || o) ? [] : s : y;
                if (n && n(y, b, a, l),
                o)
                    for (c = v(b, p),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (u = b.length; u--; )
                            (d = b[u]) && (c = r ? tt(i, d) : f[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
        ...
        function x(t, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, d, f, p = 0, h = "0", g = i && [], m = [], y = D, b = i || r && C.find.TAG("*", c), x = B += null == y ? 1 : Math.random() || .1, w = b.length;
                for (c && (D = s === O || s || c); h !== w && null != (u = b[h]); h++) {
                    if (r && u) {
                        for (d = 0,
                        s || u.ownerDocument === O || (F(u),
                        a = !L); f = t[d++]; )
                            if (f(u, s || O, a)) {
                                l.push(u);
                                break
        ...
        var w, T, C, S, $, E, k, N, D, A, j, F, O, I, L, R, q, P, H, W = "sizzle" + 1 * new Date, M = t.document, B = 0, U = 0, _ = n(), z = n(), V = n(), Q = function(t, e) {
            return t === e && (j = !0),
            0
            ...
            for (var n = 0, i = t.length; n < i; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ot = "\\[" + nt + "*(" + it + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + nt + "*\\]", rt = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", st = new RegExp(nt + "+","g"), at = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), lt = new RegExp("^" + nt + "*," + nt + "*"), ct = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ut = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), dt = new RegExp(rt), ft = new RegExp("^" + it + "$"), pt = {
            ID: new RegExp("^#(" + it + ")"),
            CLASS: new RegExp("^\\.(" + it + ")"),
            TAG: new RegExp("^(" + it + "|[*])"),
            ATTR: new RegExp("^" + ot),
        ...
        F = e.setDocument = function(t) {
            ...
            I = O.documentElement,
            L = !$(O),
            M !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)),
            ...
            q = [],
            R = [],
            (T.qsa = mt.test(O.querySelectorAll)) && (o(function(t) {
                ...
                t.querySelectorAll("[id~=" + W + "-]").length || R.push("~="),
                t.querySelectorAll(":checked").length || R.push(":checked"),
                t.querySelectorAll("a#" + W + "+*").length || R.push(".#.+[+~]")
            }),
            o(function(t) {
            ...
            (T.matchesSelector = mt.test(P = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function(t) {
                T.disconnectedMatch = P.call(t, "*"),
                P.call(t, "[s!='']:x"),
                q.push("!=", rt)
            }),
            ...
            H = e || mt.test(I.contains) ? function(t, e) {
            ...
            Q = e ? function(t, e) {
                ...
                1 & n || !T.sortDetached && e.compareDocumentPosition(t) === n ? t === O || t.ownerDocument === M && H(M, t) ? -1 : e === O || e.ownerDocument === M && H(M, e) ? 1 : A ? tt(A, t) - tt(A, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return j = !0,
                ...
                if (!o || !r)
                    return t === O ? -1 : e === O ? 1 : o ? -1 : r ? 1 : A ? tt(A, t) - tt(A, e) : 0;
                if (o === r)
                    return s(t, e);
        ...
        e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== O && F(t),
            n = n.replace(ut, "='$1']"),
            T.matchesSelector && L && !V[n + " "] && (!q || !q.test(n)) && (!R || !R.test(n)))
                try {
                    var i = P.call(t, n);
        ...
        e.contains = function(t, e) {
            return (t.ownerDocument || t) !== O && F(t),
            H(t, e)
        }
        ,
        e.attr = function(t, e) {
            ...
            var n = C.attrHandle[e.toLowerCase()]
              , i = n && X.call(C.attrHandle, e.toLowerCase()) ? n(t, e, !L) : void 0;
        ...
        C = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return pt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && dt.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, o) {
                    ...
                    : function(e, n, l) {
                        var c, u, d, f, p, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, b = !1;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (f = e; f = f[g]; )
                            ...
                            b = p),
                            b === !1)
                                for (; (f = ++p && f && f[g] || (b = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[W] || (f[W] = {}),
                                u = d[f.uniqueID] || (d[f.uniqueID] = {}),
                                u[t] = [B, b]),
                                f !== e)); )
                                    ;
        ...
        E = e.tokenize = function(t, n) {
            ...
            c = C.preFilter; a; ) {
                ...
                a = a.slice(i.length));
                for (s in C.filter)
                    !(o = pt[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(),
                    r.push({
                        value: i,
                        type: s,
                        matches: o
        ...
        N = e.select = function(t, e, n, i) {
            ...
            1 === u.length) {
                ...
                r.length > 2 && "ID" === (s = r[0]).type && 9 === e.nodeType && L && C.relative[r[1].type]) {
                    if (e = (C.find.ID(s.matches[0].replace(bt, xt), e) || [])[0],
                    !e)
                        return n;
                    c && (e = e.parentNode),
                ...
                !C.relative[a = s.type]); )
                    if ((l = C.find[a]) && (i = l(s.matches[0].replace(bt, xt), yt.test(r[0].type) && d(e.parentNode) || e))) {
                        if (r.splice(o, 1),
                        t = i.length && p(r),
                        !t)
                            return K.apply(n, i),
            ...
            return (c || k(t, u))(i, e, !L, n, !e || yt.test(t) && d(e.parentNode) || e),
            n
        }
        ,
    ...
    var $t, Et = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, kt = ht.fn.init = function(t, e, n) {
        var i, o;
        if (!t)
            return this;
        if (n = n || $t,
        "string" == typeof t) {
            if (i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : Et.exec(t),
            !i || !i[1] && e)
                return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
            if (i[1]) {
                if (e = e instanceof ht ? e[0] : e,
                ht.merge(this, ht.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : et, !0)),
                Ct.test(i[1]) && ht.isPlainObject(e))
                    for (i in e)
    ...
    ht.each({
        ...
        ht.fn[t] = function(n, i) {
            ...
            this.length > 1 && (Dt[t] || ht.uniqueSort(o),
            Nt.test(t) && o.reverse()),
            this.pushStack(o)
        }
    });
    ...
    ht.extend({
              ...
              , o = {
                ...
                then: function(e, i, o) {
                            ...
                            var c = this
                              ...
                              , d = function() {
                                ...
                                if (!(e < s)) {
                                    ...
                                    ht.isFunction(d) ? o ? d.call(t, r(s, n, a, o), r(s, n, l, o)) : (s++,
                                    d.call(t, r(s, n, a, o), r(s, n, l, o), r(s, n, a, n.notifyWith))) : (i !== a && (c = void 0,
                                    u = [t]),
                                    (o || n.resolveWith)(c, u))
                                }
                            }
                    ...
                    return ht.Deferred(function(t) {
                        n[0][3].add(r(0, t, ht.isFunction(o) ? o : a, t.notifyWith)),
                        n[1][3].add(r(0, t, ht.isFunction(e) ? e : a)),
                        n[2][3].add(r(0, t, ht.isFunction(i) ? i : l))
                    }).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (c(t, r.done(s(n)).resolve, r.reject),
    ...
    ht.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --ht.readyWait > 0 || Ft.resolveWith(et, [ht]))
        }
    }),
    ht.ready.then = Ft.then,
    "complete" === et.readyState || "loading" !== et.readyState && !et.documentElement.doScroll ? t.setTimeout(ht.ready) : (et.addEventListener("DOMContentLoaded", u),
    ...
    d.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    ht.isArray(e) ? e = e.map(ht.camelCase) : (e = ht.camelCase(e),
                    e = e in i ? [e] : e.match(At) || []),
                    n = e.length;
                    for (; n--; )
                        delete i[e[n]]
                }
    ...
    ht.extend({
        queue: function(t, e, n) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                i = Lt.get(t, e),
                n && (!i || ht.isArray(n) ? i = Lt.access(t, e, ht.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    ht.event = {
        ...
        add: function(t, e, n, i, o) {
            var r, s, a, l, c, u, d, f, p, h, g, m = Lt.get(t);
            if (m)
                for (n.handler && (r = n,
                n = r.handler,
                o = r.selector),
                o && ht.find.matchesSelector(Yt, o),
                ...
                c = e.length; c--; )
                    ...
                    (f = l[p]) || (f = l[p] = [],
                    f.delegateCount = 0,
                    d.setup && d.setup.call(t, i, h, s) !== !1 || t.addEventListener && t.addEventListener(p, s)),
        ...
        remove: function(t, e, n, i, o) {
            var r, s, a, l, c, u, d, f, p, h, g, m = Lt.hasData(t) && Lt.get(t);
            if (m && (l = m.events)) {
                for (e = (e || "").match(At) || [""],
                c = e.length; c--; )
                    if (a = Zt.exec(e[c]) || [],
                    ...
                    p) {
                        ...
                        s && !f.length && (d.teardown && d.teardown.call(t, h, m.handle) !== !1 || ht.removeEvent(t, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            ht.event.remove(t, p + e[c], n, i, !0);
                ht.isEmptyObject(l) && Lt.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, n, i, o, r, s, a = ht.event.fix(t), l = new Array(arguments.length), c = (Lt.get(this, "events") || {})[a.type] || [], u = ht.event.special[a.type] || {};
            for (l[0] = a,
            ...
            !u.preDispatch || u.preDispatch.call(this, a) !== !1) {
                ...
                e = 0; (o = s[e++]) && !a.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = r.data,
                        i = ((ht.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l),
        ...
        special: {
            ...
            click: {
                trigger: function() {
                    if ("checkbox" === this.type && this.click && ht.nodeName(this, "input"))
                        return this.click(),
                        !1
                },
                _default: function(t) {
    ...
    ht.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (!(ft.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t)))
                for (s = v(a),
                r = v(t),
                i = 0,
                o = r.length; i < o; i++)
    ...
    ht.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (ht.cleanData(v(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
            ...
            return Ot(this, function(t) {
                ...
                if ("string" == typeof t && !ee.test(t) && !Xt[(Vt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < i; n++)
                            e = this[n] || {},
                            1 === e.nodeType && (ht.cleanData(v(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return D(this, arguments, function(e) {
                ...
                ht.inArray(this, t) < 0 && (ht.cleanData(v(this)),
    ...
    ht.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" === r && (o = Wt.exec(n)) && o[1] && (n = h(t, e, o),
                r = "number"),
                void (null != n && n === n && ("number" === r && (n += o && o[3] || (ht.cssNumber[a] ? "" : "px")),
    ...
    ht.each(["height", "width"], function(t, e) {
        ht.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return !le.test(ht.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? R(t, e, i) : Ut(t, ce, function() {
                        return R(t, e, i)
                    })
            },
            set: function(t, n, i) {
                var o, r = i && ae(t), s = i && L(t, e, i, "border-box" === ht.css(t, "boxSizing", !1, r), r);
                return s && (o = Wt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n,
                n = ht.css(t, e)),
                I(t, n, s)
            }
        }
    }),
    ht.cssHooks.marginLeft = F(ft.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(j(t, "marginLeft")) || t.getBoundingClientRect().left - Ut(t, {
                marginLeft: 0
            }, function() {
    ...
    ht.speed = function(t, e, n) {
        ...
        return ht.fx.off || et.hidden ? i.duration = 0 : "number" != typeof i.duration && (i.duration in ht.fx.speeds ? i.duration = ht.fx.speeds[i.duration] : i.duration = ht.fx.speeds._default),
    ...
    ht.fn.extend({
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var e, n = Lt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = ht.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                ht.queue(this, t, []),
    ...
    ht.fx.start = function() {
        he || (he = t.requestAnimationFrame ? t.requestAnimationFrame(P) : t.setInterval(ht.fx.tick, ht.fx.interval))
    }
    ,
    ht.fx.stop = function() {
        t.cancelAnimationFrame ? t.cancelAnimationFrame(he) : t.clearInterval(he),
        he = null
    }
    ,
    ht.fx.speeds = {
    ...
    ht.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return "undefined" == typeof t.getAttribute ? ht.prop(t, e, n) : (1 === r && ht.isXMLDoc(t) || (o = ht.attrHooks[e.toLowerCase()] || (ht.expr.match.bool.test(e) ? ve : void 0)),
    ...
    ve = {
        set: function(t, e, n) {
            return e === !1 ? ht.removeAttr(t, n) : t.setAttribute(n, n),
            n
        }
    },
    ...
    ht.fn.extend({
        ...
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && (" " + z(V(n)) + " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    ht.fn.extend({
        val: function(t) {
            ...
            "string" == typeof n ? n.replace(we, "") : null == n ? "" : n)) : void 0
        }
    }),
    ht.extend({
        valHooks: {
            ...
            select: {
                get: function(t) {
                    ...
                    for (i = r < 0 ? l : s ? r : 0; i < l; i++)
                        if (n = o[i],
                        (n.selected || i === r) && !n.disabled && (!n.parentNode.disabled || !ht.nodeName(n.parentNode, "optgroup"))) {
                            if (e = ht(n).val(),
                            s)
                                return e;
                            a.push(e)
    ...
    ht.extend(ht.event, {
        trigger: function(e, n, i, o) {
            var r, s, a, l, c, u, d, f = [i || et], p = ct.call(e, "type") ? e.type : e, h = ct.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || et,
            3 !== i.nodeType && 8 !== i.nodeType && !Te.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            c = p.indexOf(":") < 0 && "on" + p,
            ...
            o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                ...
                for (r = 0; (s = f[r++]) && !e.isPropagationStopped(); )
                    ...
                    u = (Lt.get(s, "events") || {})[e.type] && Lt.get(s, "handle"),
                    u && u.apply(s, n),
                    u = c && s[c],
                    u && u.apply && It(s) && (e.result = u.apply(s, n),
                    e.result === !1 && e.preventDefault());
                return e.type = p,
                o || e.isDefaultPrevented() || d._default && d._default.apply(f.pop(), n) !== !1 || !It(i) || c && ht.isFunction(i[p]) && !ht.isWindow(i) && (a = i[c],
                a && (i[c] = null),
    ...
    ht.param = function(t, e) {
        ...
        if (ht.isArray(t) || t.jquery && !ht.isPlainObject(t))
            ht.each(t, function() {
    ...
    ht.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, a) {
                ...
                C.status = e,
                C.statusText = (n || T) + "",
                c ? v.resolveWith(g, [f, T, C]) : v.rejectWith(g, [C, T, p]),
                C.statusCode(b),
                b = void 0,
            ...
            e = void 0),
            n = n || {};
            var o, r, s, a, l, c, u, d, f, p, h = ht.ajaxSetup({}, n), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? ht(g) : ht.event, v = ht.Deferred(), y = ht.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (v.promise(C),
            h.url = ((e || h.url || Ce.href) + "").replace(Re, Ce.protocol + "//"),
            h.type = n.method || n.type || h.method || h.type,
            h.dataTypes = (h.dataType || "*").toLowerCase().match(At) || [""],
            null == h.crossDomain) {
            ...
            h.data && (r += ($e.test(r) ? "&" : "?") + h.data,
            delete h.data),
            h.cache === !1 && (r = r.replace(Fe, "$1"),
            p = ($e.test(r) ? "&" : "?") + "_=" + Se++ + p),
            h.url = r + p),
            h.ifModified && (ht.lastModified[r] && C.setRequestHeader("If-Modified-Since", ht.lastModified[r]),
            ht.etag[r] && C.setRequestHeader("If-None-Match", ht.etag[r])),
            (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && C.setRequestHeader("Content-Type", h.contentType),
            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + He + "; q=0.01" : "") : h.accepts["*"]);
            for (f in h.headers)
                C.setRequestHeader(f, h.headers[f]);
            if (h.beforeSend && (h.beforeSend.call(g, C, h) === !1 || u))
                return C.abort();
            if (T = "abort",
            y.add(h.complete),
            C.done(h.success),
                ...
                send: function(o, r) {
                    ...
                    n = function(t) {
                        return function() {
                            ...
                            "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Me[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
    ...
    ht.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            ...
            a ? e[a] = e[a].replace(_e, "$1" + o) : e.jsonp !== !1 && (e.url += ($e.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    ht.fn.extend({
        ...
        position: function() {
            if (this[0]) {
                ...
                e = this.offset(),
                ht.nodeName(t[0], "html") || (i = t.offset()),
                i = {
    ...
    ht.each(["top", "left"], function(t, e) {
        ht.cssHooks[e] = F(ft.pixelPosition, function(t, n) {
            if (n)
                return n = j(t, e),
                se.test(n) ? ht(t).position()[e] + "px" : n
        })
    }),
    ht.each({
        Height: "height",
    ...
    n.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (c) {
                ...
                a = "bottom" == a && u.bottom + f > h.bottom ? "top" : "top" == a && u.top - f < h.top ? "bottom" : "right" == a && u.right + d > h.width ? "left" : "left" == a && u.left - d < h.left ? "right" : a,
    ...
    !function(t) {
        ...
        t.ScrollToFixed = function(e, n) {
            function i() {
                ...
                S = C.offset().top,
                $ = C.offset().left,
                m.options.offsets && ($ += C.offset().left - C.position().left),
                E == -1 && (E = $),
                v = C.css("position"),
                T = !0,
                m.options.bottom != -1 && (C.trigger("preFixed.ScrollToFixed"),
                l(),
            ...
            function l() {
                if (!r()) {
                    ...
                    cssOptions = {
                        ...
                        position: "fixed",
                        top: m.options.bottom == -1 ? f() : "",
                        bottom: m.options.bottom == -1 ? "" : m.options.bottom,
                        "margin-left": "0px"
                    },
                    m.options.dontSetWidth || (cssOptions.width = C.css("width")),
                    C.css(cssOptions),
                    C.addClass(m.options.baseClassName),
                    m.options.className && C.addClass(m.options.className),
                    v = "fixed"
                }
            }
            function c() {
            ...
            function u() {
                ...
                m.options.className && C.removeClass(m.options.className),
                v = null)
            }
            function d(t) {
                t != k && (C.css("left", $ - t),
            ...
            function p() {
                if (t.isScrollToFixed(C) && !C.is(":hidden")) {
                    ...
                    var p = t(window).scrollLeft()
                      ...
                      , b = o();
                    m.options.minWidth && t(window).width() < m.options.minWidth ? a() && e || (g(),
                    C.trigger("preUnfixed.ScrollToFixed"),
                    u(),
                    C.trigger("unfixed.ScrollToFixed")) : m.options.maxWidth && t(window).width() > m.options.maxWidth ? a() && e || (g(),
                    C.trigger("preUnfixed.ScrollToFixed"),
                    u(),
                    C.trigger("unfixed.ScrollToFixed")) : m.options.bottom == -1 ? b > 0 && v >= b - f() ? n || s() && e || (g(),
                    C.trigger("preAbsolute.ScrollToFixed"),
                    c(),
                    C.trigger("unfixed.ScrollToFixed")) : v >= S - f() ? (r() && e || (g(),
                    ...
                    C.trigger("preUnfixed.ScrollToFixed"),
                    u(),
                    C.trigger("unfixed.ScrollToFixed")) : b > 0 ? v + t(window).height() - C.outerHeight(!0) >= b - (f() || -h()) ? r() && (g(),
                    C.trigger("preUnfixed.ScrollToFixed"),
                    "absolute" === y ? c() : u(),
                    C.trigger("unfixed.ScrollToFixed")) : (r() || (g(),
                    C.trigger("preFixed.ScrollToFixed"),
                    l()),
                    d(p),
                    C.trigger("fixed.ScrollToFixed")) : d(p)
                }
            }
            function h() {
            ...
            var v, y, b, x, w, T = !1, C = m.$el, S = 0, $ = 0, E = -1, k = -1, N = null, D = function(t) {
                C.is(":visible") && (T = !1,
                p())
            }, A = function(t) {
            ...
            m.init = function() {
                ...
                x = C.css("top"),
                a() && m.$el.after(N),
                t(window).bind("resize.ScrollToFixed", D),
                t(window).bind("scroll.ScrollToFixed", A),
                "ontouchmove"in window && t(window).bind("touchmove.ScrollToFixed", p),
                m.options.preFixed && C.bind("preFixed.ScrollToFixed", m.options.preFixed),
                m.options.postFixed && C.bind("postFixed.ScrollToFixed", m.options.postFixed),
                m.options.preUnfixed && C.bind("preUnfixed.ScrollToFixed", m.options.preUnfixed),
                m.options.postUnfixed && C.bind("postUnfixed.ScrollToFixed", m.options.postUnfixed),
                m.options.preAbsolute && C.bind("preAbsolute.ScrollToFixed", m.options.preAbsolute),
                m.options.postAbsolute && C.bind("postAbsolute.ScrollToFixed", m.options.postAbsolute),
                m.options.fixed && C.bind("fixed.ScrollToFixed", m.options.fixed),
                m.options.unfixed && C.bind("unfixed.ScrollToFixed", m.options.unfixed),
                m.options.spacerClass && N.addClass(m.options.spacerClass),
                ...
                C.bind("detach.ScrollToFixed", function(e) {
                    ...
                    u(),
                    C.trigger("unfixed.ScrollToFixed"),
                    t(window).unbind("resize.ScrollToFixed", D),
                    t(window).unbind("scroll.ScrollToFixed", A),
...
$(window).resize(function() {
    window.innerWidth >= 860 && $("#js-centered-navigation-menu").show()
}),
$(document).ready(function() {
    $("#js-centered-navigation-menu").click(function() {
        window.innerWidth < 860 && $(this).slideToggle()
    }),
    $(".checkbox").click(function() {
        $(".verbose").toggle(),
        stat = document.getElementById("checkbox-status"),
        "Succinct" == stat.innerHTML ? stat.innerHTML = "Verbose" : stat.innerHTML = "Succinct"
    }),
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && $(".la-jolla").addClass("la-jolla-mobile").removeClass("la-jolla");
    var t = $("#js-centered-navigation-mobile-menu").unbind();
    $("#js-centered-navigation-menu").removeClass("show"),
    t.on("click", function(t) {
        t.preventDefault(),
        $("#js-centered-navigation-menu").slideToggle(function() {
            $("#js-centered-navigation-menu").is(":hidden") && $("#js-centered-navigation-menu").removeAttr("style")
        })
    }),
    $("#prof-pic-wrap").scrollToFixed({
        zIndex: 9999,
        dontSetWidth: !0,
        preFixed: function() {
            $("#prof-pic").css({
    ...
    $(".accordion-tabs").on("click", "li > a.tab-link", function(t) {
